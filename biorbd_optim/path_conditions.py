...
class InitialConditions(PathCondition):
    def __init__(self, initial_guess=(), InitLineaire = False):
        """
        ...
        self.InitLineaire = InitLineaire
    ...
    def regulation(self, nb_elements):
        ...
        if self.InitLineaire:
            self.regulation_private(self.first_node_init, 2 * nb_elements, "First node init")
            self.regulation_private(self.last_node_init, 2 * nb_elements, "Last node init")
        else:
